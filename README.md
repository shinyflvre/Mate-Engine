...
Бесплатная, легковесная альтернатива **Desktop Mate** с поддержкой пользовательских VRM-моделей и модов. Меньше ограничений, больше свободы.

- **Лицензия приложения**: Смешанная — GNU AGPL v3 & MateProv2 License
  *Пожалуйста, внимательно прочитайте условия лицензии.*
- **Лицензия аватара по умолчанию**: Все права защищены [Yorshka Shop](https://yorshkasencho.booth.pm/)  
  *Не распространяйте эту модель в своих сборках.*
- **QWEN 2.5 1.5b LLM**: *Apache License Version 2.0, January 2004*
...
**Mate Engine** был создан как бесплатная альтернатива **Desktop Mate** и другим подобным приложениям.

Почему? Потому что **Desktop Mate** берет **$10–$25 USD** за одну модель персонажа — цены сопоставимы с полноценными играми в Steam. Более того, в более поздних версиях были отключены моды и пользовательские модели.

**Mate Engine** решает обе проблемы:

- Он **полностью бесплатный**
- Он поддерживает **пользовательские VRM-аватары**
- Он иммет **открытый исходный код и поддерживает моды**

![Mate Engine Preview](https://i.imgur.com/nNyWA1L.png)

---

## Бесплатная поддержка Hatsune Miku

Хотите попробовать с бесплатной моделью?  
[Скачать Hatsune Miku VRM](https://booth.pm/en/items/3226395)

---

## Сравнение функций
Сравнение между "Desktop Mate" , "Phase Pal (Playtest Alpha)" и "MateEngine"

| Сравнение функций                | Desktop Mate (1.6.0) | Phase Pal (Alpha) | MateEngine (X3.0) |
|--------------------------|--------------|-----------|------------|
| Открытый исходный код              | ❌           | ❌        | ✅         |
| Поддержка модов              | ❌           | ❌        | ✅         |
| Пользовательские VRM               | ❌           | ✅        | ✅         |
| Пользовательские шейдеры           | ❌           | ❌        | ✅         |
| Формат файла .ME          | ❌           | ❌        | ✅         |
| Сидение на окнах           | ✅           | ✅        | ✅         |
| Сидение на панели задач          | ✅           | ✅        | ✅         |
| Анимация простоя           | ✅           | ✅        | ✅         |
| Анимация перетаскивания       | ✅           | ✅        | ✅         |
| Танцы под музыку           | ❌           | ❌        | ✅         |
| Отслеживание головы            | ✅           | ✅        | ✅         |
| Отслеживание позвоночника           | ❌           | ❌        | ✅         |
| Отслеживание глаз             | ❌           | ❌        | ✅         |
| Движение рук            | ✅           | ❌        | ✅         |
| Будильник / Таймер            | ✅           | ✅        | ✅         |
| Заставка              | ❌           | ❌        | ✅         |
| Области касания            | ❌           | ❌        | ✅         |
| Звуковые эффекты аватара               | ❌           | ❌        | ✅         |
| Частицы         | ✅           | ❌        | ✅         |
| Управление FPS              | ❌           | ✅        | ✅         |
| Переключение "Всегда сверху"     | ❌           | ✅        | ✅         |
| Режим чиби               | ❌           | ❌        | ✅         |
| Постобработка Bloom    | ❌           | ❌        | ✅         |
| Постобработка AO       | ❌           | ❌        | ✅         |
| Поддержка MSAA x8          | ✅           | ❌        | ✅         |
...
| Системная иконка              | ✅           | ❌        | ✅         |
| Настройки системной иконки     | ❌           | ❌        | ✅         |
| Плавные переходы анимации  | ❌           | ❌        | ✅         |
| Steam Workshop           | ❌           | ✅        | ✅         |
| Встроенный SDK             | ❌           | ❌        | ✅         |
| AI Чат                  | ❌           | ✅        | ✅         |
| Продвинутые функции AI    | ❌           | ✅        | ✅         |
| Поддержка Markdown в AI    | ❌           | ❌        | ✅         |
| API функции AI         | ❌           | ✅        | ✅         |
| Бесплатное использование              | ✅           | ✅        | ✅         |
| Поддержка нескольких языков   | ❌           | ✅        | ✅         |
| AI Голоса                | ❌           | ✅        | ❌         |
| Модификация анимаций        | ❌           | ❌        | ✅         |
| Использование CPU                | Умеренное     | Очень хорошо | Очень хорошо  |
| Использование GPU                | Умеренное     | Хорошо      | Хорошо       |
| Использование RAM                | Хорошо    | Очень плохо  | Очень хорошо       |
| Безопасность для античита          | ❌           | ❌        | ✅         |
| Сон                    | ❌           | ❌        | ✅         |
| Совместимость с играми    | ❌           | ❌        | ✅         |
| Запуск с ПК    | ❌           | ❌        | ✅         |
| Поддержка редактирования Blendshape    | ❌           | ❌        | ✅         |
| Косметические предметы    | ❌           | ❌        | ✅         |
| Плеер анимации музыки MMD    | ❌           | ❌        | ✅         |
| Выражения на основе движения    | ✅           | ❌        | ✅         |
| Discord Rich Presence    | ❌           | ❌        | ✅         |
| Обратная кинематика    | ❌           | ❌        | ✅         |
| Мужские анимации    | ❌           | ❌        | ✅         |
| Настройки меню    | ❌           | ❌        | ✅         |
| Меню отладки    | ❌           | ❌        | ✅         |
| До 9 аватаров одновременно    | ❌           | ❌        | ✅         |
| Синхронизация танцев между несколькими аватарами   | ❌           | ❌        | ✅         |
...
**Прогресс финансирования:** $239.34 / $100  
**Целевая дата:** 26 марта 2025

Благодаря удивительной поддержке сообщества, **Mate Engine** будет выпущен в Steam за **$3.99** — но он всегда останется **бесплатным на GitHub**.
...
Если вы хотите помочь с будущими обновлениями или покрыть расходы Steam, вы можете пожертвовать через **PayPal**:  
**johnson@soultechno.de**  
(*Пожалуйста, добавьте примечание: "MateEngine Donation"*)
...
Mate Engine предлагает более плавные переходы анимации, чем Desktop Mate, избегая глючных, резких изменений, часто встречающихся в коммерческих альтернативах.
...
**Mate Engine** легковесный и эффективный. Использование RAM зависит от размера текстур аватара. Например, высококачественная модель "Alice" использует ~190MB памяти текстур, что приводит к ~200MB общего использования RAM. Использование более легких моделей еще больше уменьшит это.

---

## Как использовать

1. Перейдите в раздел **Releases** (на правой панели).  
2. Скачайте ZIP-файл, помеченный как публичный релиз (не исходный код).  
3. Распакуйте и запустите `MateEngineX.exe`.  
4. Щелкните правой кнопкой мыши по аватару или нажмите `M`, чтобы открыть меню настроек.

---

## Руководство для разработчиков

Хотите внести вклад? Настройка проста:

1. Клонируйте этот репозиторий и извлеките папку.  
2. Откройте **Unity Hub** → **Add Project From Disk**  
3. Выберите папку `Mate-Engine-BRANCH`  
4. Загрузите проект, затем откройте сцену:  
   `Scenes - USED FOR MATE ENGINE > Mate Engine Main`

> ⚠️ Избегайте сцен вроде *Mate Engine InDev*, если вы не на dev-ветке.

---

## Уведомление об антивирусе

Если **Windows Defender** помечает `Trojan:Script/Wacatac.B1ml`, **не волнуйтесь** — это **ложное срабатывание**, вызванное тем, что приложение не имеет цифровой подписи.

Вы можете проверить безопасность, просканировав приложение на [VirusTotal](https://www.virustotal.com/).

---

## Заключительные слова

Спасибо, что посмотрели **Mate Engine**!  
Этот проект создан с любовью и предназначен оставаться бесплатным навсегда.  
Если вам нравится, поделитесь им или поддержите его — но самое главное, наслаждайтесь им.
